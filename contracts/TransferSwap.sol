...
contract TransferSwap is MessageSenderApp, MessageReceiverApp {
    ...
    function _transferWithSwap(
        ...
        require(
            _amountIn > minSwapAmounts[_srcSwap.path[0]],
    ...
    function _trySwap(SwapInfo memory _swap, uint256 _amount)
        private
    ...
    function setMinSwapAmount(address _token, uint256 _minSwapAmount)
        external
        onlyOwner
    {
